...
# isotropic prior + FIM posterior (fixed)
...
def main():
    ...
    # model_state, rho = torch.load(path + "model_bayes_kfac1.pt", map_location=torch.device('cpu'))
    ...
    for epoch in range(epochs):
        ...
        if epoch%20 == 0:
            ...
            if epoch != 0:
                torch.save((model.state_dict(), rho.item()), path + "model_bayes_kfac1.pt")
    ...
    torch.save((stat1, stat2), path + "stat_bayes_kfac1.pt")
